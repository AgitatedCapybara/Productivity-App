    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-[var(--border-subtle)] pb-5 mb-6 drag-region">
        <div className="flex items-center gap-3 no-drag">
          ...
          <div>
            <h1 className="text-[34px] font-bold tracking-tight text-zinc-100 mb-1" id="deepwork-view-title">
              Deep Work & Burnout Intelligence
            </h1>
            <p className="text-xs text-zinc-400">
              Personal-by-default, compute-locally wellness telemetry protecting cognitive sustainability.
            </p>
          </div>
        </div>

        {/* Global Toggle & Control Actions */}
        <div className="flex items-center gap-3 no-drag shrink-0">
          <button
            onClick={handleExportData}
            className="flex items-center gap-2 px-3.5 py-1.5 text-xs text-zinc-300 hover:text-white bg-zinc-900/50 hover:bg-zinc-850 border border-zinc-800/80 rounded-xl transition-all cursor-pointer shadow-sm active:scale-98"
            title="Export full logs to standard local JSON"
          >
            <Download size={14} />
          ...
          <div className="flex items-center gap-2.5 bg-zinc-900/40 border border-zinc-800/40 rounded-xl px-3 py-1.5 shadow-sm">
            <span className="text-[11px] font-bold uppercase tracking-wider text-zinc-400">Heuristics:</span>
            <button
            ...
            >
              <span
                className={cn(
                  ...
                  generalEnabled ? "translate-x-4" : "translate-x-0"
                )}
              />
            </button>
          </div>
      ...
      {activeSessionId ? (
        ...
        <div className="mb-6 p-6 border border-zinc-900 bg-zinc-900/10 backdrop-blur-md rounded-2xl flex flex-col gap-5" id="self-regulated-timer-panel">
          <div className="flex items-center gap-3 pb-3 border-b border-zinc-900/60">
            ...
            <div>
              <h3 className="text-sm font-bold text-zinc-150 uppercase tracking-wider leading-none">
                Self-Regulated Focus Timer
              </h3>
              <p className="text-[11px] text-zinc-400 mt-1">
                Select a duration matched to your cognitive capacity. Rigid schedules accelerate fatigue.
              </p>
            </div>
          </div>

          <div className="grid grid-cols-2 gap-6">
            {/* Left Column: Dual tracks (Study & Break Durations) */}
            <div className="space-y-6">
              {/* Study Duration track */}
              <div className="space-y-3" id="study-track-container">
                ...
                <input
                  ...
                  className="w-full accent-indigo-500 h-1 bg-zinc-850 rounded-lg appearance-none cursor-pointer"
                  id="study-duration-slider"
                />
              </div>

              {/* Break Duration track */}
              <div className="space-y-3" id="break-track-container">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] font-bold uppercase tracking-wider text-zinc-400 flex items-center gap-1">
                    ☕ BREAK DURATION
                  </span>
            ...
            <div className="space-y-4">
              <span className="text-[10px] font-bold uppercase tracking-wider text-zinc-400 block">
                Associated Project Group (Optional)
              </span>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                >
                  ...
                  {selectedProjectId === null && <Check size={10} className="ml-1 text-purple-400" />}
                </button>
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "flex items-center gap-1.5 px-3 py-1.5 rounded-xl border text-xs font-bold cursor-pointer transition-all",
                        isSelected
                          ? "bg-zinc-900 text-zinc-150 font-bold border-zinc-700"
                          : "bg-zinc-950/40 border-zinc-850 text-zinc-400 hover:text-zinc-200"
                      )}
                      style={{
          ...
          <div className="flex justify-end pt-3 border-t border-zinc-900/60">
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold uppercase tracking-wider rounded-xl cursor-pointer transition-all shadow-md active:scale-95 disabled:opacity-50"
              id="btn-launch-self-regulated"
            >
              <Rocket size={14} />
              <span>Launch focus session ({targetStudyDurationMins}m)</span>
            </button>
          </div>
        </div>
      )}

      {/* Grid spacing for Bento Analytics Cards */}
      <div className="grid grid-cols-12 gap-6 items-start mb-6">
        {/* Left Side: Daily Deep Work Summary & Bento Hourly Map */}
        <div className="col-span-8 flex flex-col gap-6">
          {chartData.length === 0 ? (
            <motion.div 
              ...
              className="p-10 text-center bg-zinc-900/10 border border-zinc-900 rounded-2xl shadow-xl select-none flex flex-col items-center justify-center gap-5 min-h-[30rem] border-dashed"
            >
              <div className="p-4 bg-purple-600/10 text-purple-400 rounded-2xl border border-purple-500/20">
                <Hourglass size={28} className="animate-pulse" />
              </div>
              <div className="space-y-1.5">
                <h3 className="text-sm font-bold text-zinc-150 uppercase tracking-widest">No focus sessions yet</h3>
                <p className="text-xs text-zinc-400 leading-relaxed max-w-sm mx-auto">
                  "No sessions yet. Start when you're ready."
                </p>
              </div>
              <button
                onClick={() => setActiveView('today')}
                className="px-5 py-2.5 bg-purple-600 hover:bg-purple-500 text-white text-[11px] font-bold uppercase tracking-wider rounded-xl cursor-pointer transition-all shadow-md active:scale-95 flex items-center gap-2"
              >
                <Plus size={12} />
            ...
            <div className="p-5 border border-zinc-900 bg-zinc-900/10 rounded-2xl flex flex-col gap-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-zinc-400 mt-1">
                      Explore long-term focus metrics and bio-rhythms. Your data remains fully encrypted and local.
                    </p>
                  </div>
                </div>
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-4 py-2 bg-zinc-950/60 hover:bg-zinc-900 border border-zinc-850 rounded-xl text-xs font-bold uppercase tracking-wider text-zinc-350 hover:text-white transition-all cursor-pointer"
                >
                  {isAnalyticsExpanded ? (
                    <>
                      <EyeOff size={13} />
              ...
              {isAnalyticsExpanded && (
                <div className="pt-4 border-t border-zinc-900/60 flex flex-col gap-6 animate-fade-in">
                  {/* Card 1: Daily Deep Work Completed Minutes Chart */}
                  <div className="border border-zinc-900 bg-zinc-900/20 backdrop-blur-md rounded-2xl p-5 flex flex-col h-72">
                    <div className="flex items-center justify-between gap-3 mb-4">
                      ...
                      <div className="text-right">
                        <span className="text-xs text-zinc-500/70 text-[13px] font-normal">Uninterrupted blocks &gt;= 25min</span>
                      </div>
                    </div>
                  ...
                  {/* Card 1.5: Focus Preservation & Distraction Cycles LineChart */}
                  <div className="border border-zinc-900 bg-zinc-900/20 backdrop-blur-md rounded-2xl p-5 flex flex-col h-72" id="distraction-trend-card">
                    <div className="flex items-center justify-between gap-3 mb-4">
                      <div className="space-y-0.5">
                        <span className="text-[10px] font-bold uppercase tracking-wider text-indigo-400">Cognitive Harmony</span>
                        <h3 className="text-xs font-semibold text-zinc-250 uppercase tracking-widest">
                      ...
                      <div className="text-right flex items-center gap-4 text-[10px] font-semibold">
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-zinc-500/70 text-[13px] font-normal">Preservation (%)</span>
                        </div>
                        <div className="flex items-center gap-1.5">
                          <div className="w-2.5 h-0.5 bg-amber-400" />
                          <span className="text-zinc-500/70 text-[13px] font-normal">Avg Distractions</span>
                        </div>
                      </div>
                    </div>
                  ...
                  {/* Card 2: Peak focus hourly map (24hr contributor layout) */}
        ...
        {/* Right Side: Rule configuration and Local Privacy Toggles */}
        <div className="col-span-4 flex flex-col gap-6">
          {/* Card 3: Active triggers list with granular item toggles */}
          <div className="border border-zinc-900 bg-zinc-900/20 backdrop-blur-md rounded-2xl p-5">
            <div className="flex items-center gap-2 mb-4 pb-2 border-b border-zinc-900">
              <Settings size={14} className="text-zinc-400" />
              <h3 className="text-xs font-semibold text-zinc-250 uppercase tracking-widest leading-none">
                Granular Rules Engine
              </h3>
            </div>

            <p className="text-[11px] text-zinc-400 mb-4 leading-relaxed">
              Toggle specific burnout and fatigue pattern alerts. Disabled flags are bypassed during evaluation.
            </p>
            ...
            <div className="space-y-3.5">
              {[
                ...
                <div key={rule.id} className="flex items-start justify-between gap-3 p-2.5 rounded-xl border border-zinc-900 bg-zinc-950/15">
                  <div className="space-y-0.5">
                    <p className="text-xs font-bold leading-none text-zinc-200">{rule.label}</p>
                    <p className="text-[10px] text-zinc-400 leading-relaxed max-w-[200px]">{rule.desc}</p>
                  </div>
                  <button
                    onClick={() => handleToggleRule(rule.id, !rules[rule.id])}
                    className={cn(
                      "relative inline-flex h-4.5 w-8 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none self-center",
                  ...
                  >
                    <span
                      className={cn(
                        ...
                        rules[rule.id] ? "translate-x-3.5" : "translate-x-0"
                      )}
                    />
                  </button>
                </div>
              ...
              <div className="pt-2.5 border-t border-zinc-900 flex items-center justify-between">
                ...
                >
                  <span
                    className={cn(
                      "pointer-events-none inline-block h-3.5 w-3.5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out",
                      sidebarEnabled ? "translate-x-3.5" : "translate-x-0"
                    )}
                  />
                </button>
              </div>
          ...
          {/* Card 4: Hardware privacy diagnostic credentials */}
          <div className="border border-zinc-900 bg-zinc-900/20 backdrop-blur-md rounded-2xl p-5">
            <div className="flex items-center gap-2 mb-3 pb-2 border-b border-zinc-900">
              <Info size={14} className="text-zinc-450" />
              <h3 className="text-xs font-semibold text-zinc-250 uppercase tracking-widest leading-none">
                Diagnostic & Privacy status
              </h3>
            </div>

            <div className="space-y-3.5 text-xs text-zinc-400">
              <div className="space-y-1">
                <p className="font-bold uppercase tracking-wider text-[10px] text-zinc-500">Security guarantee</p>
                <div className="flex items-center gap-2 text-emerald-400 font-semibold bg-emerald-950/15 border border-emerald-950 px-2 py-1.5 rounded-xl">
                  <Check size={14} />
              ...
              <div className="space-y-1 leading-relaxed text-[11px]">
                <p className="font-bold uppercase tracking-wider text-[10px] text-zinc-500">Local isolation sandbox path</p>
                <p className="font-mono bg-zinc-950/30 p-1.5 rounded-xl border border-zinc-900 text-[10px] break-all leading-tight">
                  {analytics?.privacy?.localDbPath || 'app.db (sandboxedUserDataDirectory)'}
                </p>
              </div>

              <div className="p-2.5 bg-red-950/5 border border-red-950/20 rounded-xl space-y-2 mt-4">
                <div className="flex items-start gap-2 text-red-400">
                  <ShieldAlert size={14} className="mt-0.5 shrink-0" />
                  <div className="space-y-0.5">
                    <p className="font-bold text-[11px]">Purge Sandbox</p>
                    <p className="text-[10px] leading-relaxed text-zinc-400">
                      Wipe all focus logs, logs, reflections, and context settings instantly. Irreversible.
                    </p>
                  </div>
                </div>
                ...
                {confirmPurge ? (
                  <div className="flex items-center gap-2 mt-2">
                    <button
                      ...
                      className="flex-1 py-1.5 text-[10px] font-bold bg-zinc-900 text-zinc-300 rounded-lg hover:bg-zinc-800 transition-colors uppercase cursor-pointer"
                    >
                      Cancel
                    </button>
                    <button
                      onClick={handlePurgeHistory}
                      className="flex-1 py-1.5 text-[10px] font-bold bg-red-650 hover:bg-red-600 text-white rounded-lg transition-colors uppercase cursor-pointer"
                    >
                      Yes, Wipe
                    </button>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-1.5 py-1.5 text-[10px] font-bold uppercase tracking-wider text-red-400 hover:text-white bg-red-900/10 hover:bg-red-600 border border-red-900/15 rounded-lg transition-all cursor-pointer mt-1"
                  >
                    <Trash2 size={12} />
